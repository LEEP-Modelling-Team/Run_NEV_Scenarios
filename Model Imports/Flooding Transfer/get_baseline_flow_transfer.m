...
load([water_transfer_data_folder,'NEVO_Water_Transfer_data.mat'])
...
for i = 1:num_basin
    ...
    for decade = [2029, 2039, 2049, 2059]
        ...
        load([water_transfer_data_folder,'\Base Run\base', num2str(basin_id), '_', num2str(decade), '.mat'])
...
save([water_transfer_data_folder, 'Water Transfer\baseline_flow_transfer.mat'], 'flow_results', 'subctch_ids')
