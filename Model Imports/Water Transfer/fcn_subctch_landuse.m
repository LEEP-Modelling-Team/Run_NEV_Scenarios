function [base_lcs_subctch, base_lcs_subctch_cells] = fcn_subctch_landuse(uk_baseline, es_agriculture, parameters, model_flags, conn)
    ...
    cell_info = join(uk_baseline, cell_info);

    % (c) Take averages in decades 2020-2029, 2030-2039, 2040-2049, 2050-2059
    % -----------------------------------------------------------------------
