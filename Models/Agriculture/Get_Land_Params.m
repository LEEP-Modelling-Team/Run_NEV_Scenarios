function [landtype] = Get_Land_Params
...
landtype(1).Nrate       = 199;
landtype(1).P2O5rate    = 59;
landtype(1).K2Orate     = 65;
landtype(1).CaOrate     = 4700;
...
landtype(2).Nrate       = 196;
landtype(2).P2O5rate    = 62;
landtype(2).K2Orate     = 75;
landtype(2).CaOrate     = 3600;
...
landtype(3).Nrate       = 170;
landtype(3).P2O5rate    = 133;
landtype(3).K2Orate     = 225;
